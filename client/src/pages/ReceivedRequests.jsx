        ...
        <div>
          {requests.length===0 ? (
            <div className="card text-center py-12">
              ...
              <p className="text-sm text-gray-500 mt-2">When buyers request your items, they'll appear here</p>
            </div>
          ) : (
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 gap-3 text-sm mb-3">
                        <div>
                          ...
                          <p className="font-medium text-gray-900">{r.buyerId?.name || 'Unknown'}</p>
                        </div>
                        <div>
                          <p className="text-gray-500">Buyer Email</p>
                          <p className="font-medium text-gray-900 text-xs">{r.buyerId?.email || 'N/A'}</p>
                        </div>
                        <div>
                      ...
                      {r.message && (
                        <div className="bg-blue-50 p-2 rounded mb-3 border-l-2 border-blue-500">
                          <p className="text-xs text-gray-600">Buyer's message:</p>
